...
_alphabetColor(BuildContext context, int index) {
  ...
  return GetBuilder<AlphabetsController>(builder: (logic) {
    if (logic.isShow!) {
      ...
      Utils.textToSpeech(logic.alphabetsList![index].ttsText!, MyApp.flutterTts);
    }
    return Container(
      ...
      child: FloodFillImage(
        ...
        imageProvider: AssetImage(
          Constant.getAssetDrag()+"${logic.alphabetsList![index].alphaImage}.webp",
        ),
        height: (MediaQuery
            .of(context)
            .size
    ...
    return AnimatedOpacity(
      ...
      child: Container(
        ...
        child: Column(
          children: [
            Image.asset(
              Constant.getAssetDrag()+"${logic.alphabetsList![index].objectImage}.webp",
              height: MediaQuery
                  .of(context)
                  .size
                  .height * 0.25,
