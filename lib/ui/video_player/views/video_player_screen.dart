...
class VideoPlayerScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: GetBuilder<VideoPlayerController>(builder: (logic) {
        return YoutubePlayerBuilder(
          ...
          player: YoutubePlayer(
            ...
            showVideoProgressIndicator: true,actionsPadding: EdgeInsets.all(10),
                                ...
                                child: SizedBox(
                                  ...
                                  child: ClipRRect(
                                    ...
                                    child: PhotoView(
                                      ...
                                      minScale:
                                          PhotoViewComputedScale.covered * 1.35,
                                      maxScale:
                                          PhotoViewComputedScale.covered * 1.35,
                                      imageProvider:
                                          NetworkImage(logic.videoThumb[index]),
                                    ),
                                  ),
                                ),
                              ),
